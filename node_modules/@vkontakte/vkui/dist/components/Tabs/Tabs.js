  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", _extends({}, restProps, {
        ref: getRootRef,
        className: (0, _classNames2.default)(baseClassName, (_classNames = {}, _defineProperty(_classNames, "Tabs--".concat(this.theme), true), _defineProperty(_classNames, "Tabs--".concat(type), true), _classNames), className),
        style: style
      }), children);
    }
  }, {
