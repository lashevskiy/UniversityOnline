    ...
    value: function loadModule(moduleName) {
      ...
      return new Promise(function (resolve, reject) {
        _this3.getApi().modules.require(moduleName, function (Module) {
          set$1(_this3.api, moduleName, Module, true);
          resolve(Module);
...
var _Map = withYMaps(Map$1, true, ['Map']);
...
function createGeoObject(name, propTypes$$1, modifyConstructor) {
  ...
  if (process.env.NODE_ENV !== 'production') {
    ...
    GeoObject.propTypes = propTypes$$1;
  }
...
function createControl(name, propTypes$$1) {
